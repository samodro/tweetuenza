...
public class UpdateTweet extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ui_menuupdate);
        ...
        if (!cd.isConnectingToInternet()) {
            ...
            alert.showAlertDialog(UpdateTweet.this, "Internet Connection Error",
        ...
        if(TWITTER_CONSUMER_KEY.trim().length() == 0 || TWITTER_CONSUMER_SECRET.trim().length() == 0){
            // Internet Connection is not present
            alert.showAlertDialog(UpdateTweet.this, "Twitter oAuth tokens", "Please set your twitter oauth tokens first!", false);
            // stop executing code by return
            return;
        }
      ...
      //button LihatList
        btnLihatList.setOnClickListener(new View.OnClickListener() {
	        ...
	        {
	            Intent intent = new Intent(UpdateTweet.this, ListPenyakitActivity.class);
...
//    }
    ...
    class updateTwitterStatus extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(UpdateTweet.this);
